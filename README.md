...
**v0.1.9** — core library, CLI (table / JSON / JSONL / CSV / TSV / SARIF / HTML / Markdown / JUnit), optional EPSS, KEV, filters, examples, tests, CI `@v0.3.0`, ADR-001–004. See [CHANGELOG.md](CHANGELOG.md).
